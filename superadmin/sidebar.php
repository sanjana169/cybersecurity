...
<nav class="bg-dark text-white vh-100 p-3 main-menu" style="width: 250px;">
    <ul class="nav flex-column ">
        ...
        <li class="nav-item">
            <a class="nav-link text-white <?php echo $currentPage == 'users.php' ? 'active' : ''; ?>"
                href="users.php">Manage Users</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white <?php echo $currentPage == 'admin.php' ? 'active' : ''; ?>"
                href="admin.php">Manage Admin</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white <?php echo $currentPage == 'role.php' ? 'active' : ''; ?>"
                href="role.php">Manage Role</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white <?php echo $currentPage == 'incidents.php' ? 'active' : ''; ?>"
                href="incidents.php">Manage Incidents</a>
        </li>
    </ul>
</nav>
